...
class mainWindow():
    ...
    def createGui(self):
        ...
        self.lower_slider = tkinter.Scale(self.window, from_=0, to=600, orient=HORIZONTAL,variable=self.lower_limit, length=1200,
                                          resolution=1, command=lambda value: self.sliderChanged(value))
        self.lower_slider.pack()

        self.upper_slider = tkinter.Scale(self.window, from_=0, to=600, orient=HORIZONTAL, length=1200,
                                          variable=self.upper_limit, resolution=1, command=lambda value: self.sliderChanged(value))
...
if __name__ == '__main__':
    ...
    pathh = r'C:\\Users\\gracj\\OneDrive\\Obrazy\\Canny_cot\\cot1.jpg'
